...
export function Register() {
  ...
  return <div className="login-screen" style={{ height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'url("/landing-bg.png") center/cover no-repeat', position: 'relative' }}>
    ...
    <form onSubmit={handleRegister} style={{ background: 'rgba(255, 255, 255, 0.85)', backdropFilter: 'blur(12px)', padding: '32px', borderRadius: '16px', boxShadow: '0 8px 32px rgba(0,0,0,0.1)', width: '340px' }}>
